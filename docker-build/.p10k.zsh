# Generated by Powerlevel10k configuration wizard on 2026-07-07 at 17:07 MSK.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    # context               # user@hostname — shown on the LEFT prompt only (avoid duplicate)
  ...
  # devbox: ascii instead of nerdfont-v3 so the prompt renders without a Nerd Font.
  ...
  # devbox: always show user@host (line commented out).
